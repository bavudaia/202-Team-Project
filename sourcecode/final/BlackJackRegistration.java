...
public class BlackJackRegistration extends World
{
    ...
    {    
        ...
        addObject(new Label(200, 37, "UserName",false), 200, 139);
        addObject(new Label(200, 37, "Password",false), 200, 189);
        addObject(new Label(200, 37, "Confirm Password",false), 200, 239);
        addObject(username, 420, 140);
        addObject(passWord, 420, 190);
        addObject(confirmPassword, 420, 240);
        addObject(new Register(username,passWord,confirmPassword), 330, 320);
    }
}
